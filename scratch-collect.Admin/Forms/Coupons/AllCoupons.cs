...
namespace scratch_collect.Admin.Forms.Coupons
{
    public partial class AllCoupons : Form
    {
        ...
        private async void vouchers_delete_button_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                var deleted = await CouponService.DeleteCoupon((int)selectedID);
        ...
        public async Task FetchCouponsData()
        {
            ...
            try
            {
                var coupons = await CouponService.GetAllVouchers(textQuery: "");
        ...
        private void HandleFilterSuccess(List<CouponDTO> coupons)
        {
            // Data
            vouchers_datagrid.DataSource = coupons;
