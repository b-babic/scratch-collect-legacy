...
namespace scratch_collect.Desktop.Forms.Merchants
{
    public partial class AllMerchants : Form
    {
        ...
        private async void merchants_delete_button_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                var deleted = await _merchantService.Delete((int)selectedID);
        ...
        private void HandleDataSuccess(List<MerchantVM> merchants)
        {
        ...
        private void HandleFilterSuccess(List<MerchantVM> merchants)
        {
            // Data
            merchants_datagrid.DataSource = merchants;
